							...
							<tr>
								...
								<td width="90">
									<div class="dropdown">
										...
										<a data-bs-toggle="modal" data-bs-target="#addpermissionModal" class="dropdown-item" wire:click="addpermissions({{$row->id}})"><i class="fa fa-plus-circle"></i> Asignar Permisos </a>
									<a data-bs-toggle="modal" data-bs-target="#updatepermissionModal" class="dropdown-item" wire:click="editpermissions({{$row->id}})"><i class="fa fa-minus-circle"></i> Editar Permisos </a>
