    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title" id="createDataModalLabel">Nuevo Rol</h5>
           ...
           <div class="modal-body">
				<form>
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="name" type="text" class="form-control" id="name" placeholder="Nombre del rol">@error('name') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <!--<div class="form-group">
